...
----> before:             if(books.size()==0){ <br />
----> after:             if(books.size()!=0){ <br />
----> line number in original file: 189 <br />
----> mutated node: 2008 <br />

## Failed Test Methods:
### BookServiceTest :
shouldFailToReturnBooksFilteredByGenre() <br />
shouldReturnBooksFilteredByGenre() <br />
