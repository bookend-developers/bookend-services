...
export default class Books extends React.Component {
    ...
    handleDeleteBook(shelfId,bookId){
        ...
        fetch("http://localhost:8083/api/shelf/delete/"+shelfId+"/"+bookId, requestOptions)
                        ...
                        {(this.state.rowsPerPage > 0
                            ...
                            <TableRow >
                                ...
                                <TableCell><div><Button
                                    onClick={()=>this.handleDeleteBook(this.props.location.state.shelfId,row.id)}
